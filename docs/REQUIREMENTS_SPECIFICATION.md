# ハザクラ 要件定義書（Requirements Specification Document）

**バージョン**: 1.0  
**作成日**: 2026-02-17  
**プロジェクト名**: ハザクラ - 次世代作家支援プラットフォーム  
...
### 1.1 製品ビジョン
ハザクラは、Gemini AIの全知性（Unified Context）を搭載した次世代作家支援プラットフォームです。プロジェクトごとにAIとの会話履歴、プロット、設定、執筆本文が完全に統合され、説明不要で文脈を理解する執筆体験を提供します。
