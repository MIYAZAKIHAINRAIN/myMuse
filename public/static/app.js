// 葉桜 - Next Generation Writer Support Platform
...
const i18n = {
  ja: {
    'app.title': '葉桜', 'app.tagline': '創作の未来をともに描くパートナー',
    ...
    'legal.termsTitle': '葉桜 利用規約', 'legal.termsAcceptance': '規約への同意',
    'legal.termsAcceptanceText': '本サービスを利用することにより、本利用規約に同意したものとみなされます。',
    'legal.termsService': 'サービスの内容',
    'legal.termsServiceText': '葉桜は創作活動を支援するためのAIアシスタントサービスです。執筆補助、プロット構成、キャラクター設定などの機能を提供します。',
    ...
    'legal.privacyTitle': '葉桜 プライバシーポリシー',
    ...
    'ui.guestLogin': 'ゲストとしてログインしました！', 'ui.welcomeMsg': '葉桜へようこそ！',
    ...
    // Placeholder texts
    'placeholder.yourName': 'あなたの名前', 'placeholder.email': 'your@email.com',
    'placeholder.password': '6文字以上', 'placeholder.confirmPassword': 'パスワードを再入力',
    'placeholder.storyBeginning': '物語の始まり', 'placeholder.storyDevelopment': '物語の展開',
    'placeholder.climax': 'クライマックス', 'placeholder.storyEnding': '物語の結末',
    'placeholder.settingIntro': '設定、登場人物紹介', 'placeholder.conflictStruggle': '対立と葛藤',
    'placeholder.climaxResolution': 'クライマックス、解決',
    'placeholder.kiDescription': '物語の始まり、登場人物や世界観の紹介',
    'placeholder.shoDescription': '物語の展開、問題や困難の発生',
    'placeholder.tenDescription': 'クライマックス、予想外の展開',
    'placeholder.ketsuDescription': '物語の結末、解決と余韻',
    'placeholder.act1Description': '設定、登場人物紹介、日常世界、きっかけとなる事件',
    'placeholder.act2Description': '対立と葛藤、試練、ミッドポイント、最大の危機',
    'placeholder.act3Description': 'クライマックス、解決、新たな日常',
    'placeholder.keywords': 'キーワード（任意）', 'placeholder.askAboutIdeas': 'アイデアについて相談...',
    'placeholder.illustrationPrompt': '例: 夕暮れの草原で剣を構える少女、風になびく金髪、決意に満ちた瞳',
    'placeholder.negativePrompt': '除外したい要素（例: low quality, blurry, bad anatomy）',
    'placeholder.writeStory': 'ここに物語を紡いでください...', 'placeholder.aiInstruction': 'AIへの指示を入力...',
    'placeholder.askQuestion': '質問・相談...', 'placeholder.askAboutWork': '作品について質問・相談...',
    'placeholder.consultAI': '相談したいことを入力...', 'placeholder.seriesExample': '例：〇〇シリーズ',
    'placeholder.seriesDescription': 'シリーズの概要や説明', 'placeholder.enterCode': 'コードを入力',
    'placeholder.eventName': 'イベント名', 'placeholder.memoOptional': 'メモ（任意）',
    'placeholder.seriesExample2': '例: 異世界冒険譚シリーズ', 'placeholder.seriesOverview': 'シリーズの概要を入力...',
    'placeholder.episodeExample': '例: 第1話 冒険の始まり',
  ...
  en: {
    ...
    'legal.termsTitle': '葉桜 Terms of Service', 'legal.termsAcceptance': 'Acceptance of Terms',
    ...
    'legal.termsServiceText': '葉桜 is an AI assistant service for creative writing. It provides features for writing assistance, plot construction, and character development.',
    ...
    'legal.privacyTitle': '葉桜 Privacy Policy',
    ...
    'ui.guestLogin': 'Logged in as guest!', 'ui.welcomeMsg': 'Welcome to 葉桜!',
    ...
    // Placeholder texts
    'placeholder.yourName': 'Your name', 'placeholder.email': 'your@email.com',
    'placeholder.password': '6+ characters', 'placeholder.confirmPassword': 'Confirm password',
    'placeholder.storyBeginning': 'Story beginning', 'placeholder.storyDevelopment': 'Story development',
    'placeholder.climax': 'Climax', 'placeholder.storyEnding': 'Story ending',
    'placeholder.settingIntro': 'Setting, character introduction', 'placeholder.conflictStruggle': 'Conflict and struggle',
    'placeholder.climaxResolution': 'Climax, resolution',
    'placeholder.kiDescription': 'Story beginning, character and world introduction',
    'placeholder.shoDescription': 'Story development, problems and difficulties',
    'placeholder.tenDescription': 'Climax, unexpected turn',
    'placeholder.ketsuDescription': 'Story ending, resolution and aftermath',
    'placeholder.act1Description': 'Setup, character intro, ordinary world, inciting incident',
    'placeholder.act2Description': 'Conflict, trials, midpoint, greatest crisis',
    'placeholder.act3Description': 'Climax, resolution, new normal',
    'placeholder.keywords': 'Keywords (optional)', 'placeholder.askAboutIdeas': 'Ask about ideas...',
    'placeholder.illustrationPrompt': 'e.g.: A girl wielding a sword on a sunset meadow, golden hair in the wind, determined eyes',
    'placeholder.negativePrompt': 'Elements to exclude (e.g.: low quality, blurry, bad anatomy)',
    'placeholder.writeStory': 'Write your story here...', 'placeholder.aiInstruction': 'Enter AI instruction...',
    'placeholder.askQuestion': 'Ask a question...', 'placeholder.askAboutWork': 'Ask about your work...',
    'placeholder.consultAI': 'Enter your question...', 'placeholder.seriesExample': 'e.g.: Fantasy Series',
    'placeholder.seriesDescription': 'Series overview', 'placeholder.enterCode': 'Enter code',
    'placeholder.eventName': 'Event name', 'placeholder.memoOptional': 'Memo (optional)',
    'placeholder.seriesExample2': 'e.g.: Isekai Adventure Series', 'placeholder.seriesOverview': 'Enter series overview...',
    'placeholder.episodeExample': 'e.g.: Episode 1 - The Beginning',
  ...
  zh: {
    ...
    'legal.termsTitle': '葉桜 服务条款', 'legal.privacyTitle': '葉桜 隐私政策',
    'legal.termsAcceptance': '条款接受', 'legal.termsAcceptanceText': '使用本服务即表示您同意这些服务条款。',
    'legal.termsService': '服务说明', 'legal.termsServiceText': '葉桜是一款AI创作助手服务，提供写作辅助、情节构建和角色开发等功能。',
    ...
    'ui.guestLogin': '已以访客身份登录！', 'ui.welcomeMsg': '欢迎来到葉桜！',
    ...
    // Placeholder texts
    'placeholder.yourName': '你的名字', 'placeholder.email': 'your@email.com',
    'placeholder.password': '6位以上', 'placeholder.confirmPassword': '确认密码',
    'placeholder.storyBeginning': '故事开端', 'placeholder.storyDevelopment': '故事发展',
    'placeholder.climax': '高潮', 'placeholder.storyEnding': '故事结局',
    'placeholder.settingIntro': '设定、人物介绍', 'placeholder.conflictStruggle': '冲突与挣扎',
    'placeholder.climaxResolution': '高潮、解决',
    'placeholder.kiDescription': '故事开端、人物和世界观介绍',
    'placeholder.shoDescription': '故事发展、问题和困难',
    'placeholder.tenDescription': '高潮、意外转折',
    'placeholder.ketsuDescription': '故事结局、解决和余韵',
    'placeholder.act1Description': '设定、人物介绍、日常世界、触发事件',
    'placeholder.act2Description': '冲突、试炼、中点、最大危机',
    'placeholder.act3Description': '高潮、解决、新常态',
    'placeholder.keywords': '关键词（可选）', 'placeholder.askAboutIdeas': '关于创意咨询...',
    'placeholder.illustrationPrompt': '例：夕阳草原上持剑的少女，金发随风飘扬，坚定的眼神',
    'placeholder.negativePrompt': '要排除的元素（例：low quality, blurry）',
    'placeholder.writeStory': '在这里书写你的故事...', 'placeholder.aiInstruction': '输入AI指令...',
    'placeholder.askQuestion': '提问...', 'placeholder.askAboutWork': '关于作品提问...',
    'placeholder.consultAI': '输入你的问题...', 'placeholder.seriesExample': '例：奇幻系列',
    'placeholder.seriesDescription': '系列概述', 'placeholder.enterCode': '输入代码',
    'placeholder.eventName': '事件名称', 'placeholder.memoOptional': '备注（可选）',
    'placeholder.seriesExample2': '例：异世界冒险系列', 'placeholder.seriesOverview': '输入系列概述...',
    'placeholder.episodeExample': '例：第1章 冒险开始',
  ...
  ko: {
    ...
    'legal.termsTitle': '葉桜 이용약관', 'legal.privacyTitle': '葉桜 개인정보 처리방침',
    'legal.termsAcceptance': '약관 동의', 'legal.termsAcceptanceText': '본 서비스를 이용함으로써 이 이용약관에 동의하는 것입니다.',
    'legal.termsService': '서비스 설명', 'legal.termsServiceText': '葉桜는 창작 활동을 위한 AI 어시스턴트 서비스입니다. 글쓰기 지원, 플롯 구성, 캐릭터 개발 등의 기능을 제공합니다.',
    ...
    'ui.guestLogin': '게스트로 로그인했습니다!', 'ui.welcomeMsg': '葉桜에 오신 것을 환영합니다!',
    ...
    // Placeholder texts
    'placeholder.yourName': '이름', 'placeholder.email': 'your@email.com',
    'placeholder.password': '6자 이상', 'placeholder.confirmPassword': '비밀번호 확인',
    'placeholder.storyBeginning': '이야기 시작', 'placeholder.storyDevelopment': '이야기 전개',
    'placeholder.climax': '클라이맥스', 'placeholder.storyEnding': '이야기 결말',
    'placeholder.settingIntro': '설정, 등장인물 소개', 'placeholder.conflictStruggle': '갈등과 시련',
    'placeholder.climaxResolution': '클라이맥스, 해결',
    'placeholder.kiDescription': '이야기 시작, 등장인물과 세계관 소개',
    'placeholder.shoDescription': '이야기 전개, 문제와 어려움',
    'placeholder.tenDescription': '클라이맥스, 예상치 못한 전개',
    'placeholder.ketsuDescription': '이야기 결말, 해결과 여운',
    'placeholder.act1Description': '설정, 등장인물 소개, 일상, 사건 발단',
    'placeholder.act2Description': '갈등, 시련, 중간점, 최대 위기',
    'placeholder.act3Description': '클라이맥스, 해결, 새로운 일상',
    'placeholder.keywords': '키워드 (선택)', 'placeholder.askAboutIdeas': '아이디어에 대해 질문...',
    'placeholder.illustrationPrompt': '예: 석양의 초원에서 검을 든 소녀, 바람에 흩날리는 금발, 결연한 눈빛',
    'placeholder.negativePrompt': '제외할 요소 (예: low quality, blurry)',
    'placeholder.writeStory': '여기에 이야기를 써보세요...', 'placeholder.aiInstruction': 'AI 지시 입력...',
    'placeholder.askQuestion': '질문하기...', 'placeholder.askAboutWork': '작품에 대해 질문...',
    'placeholder.consultAI': '질문을 입력하세요...', 'placeholder.seriesExample': '예: 판타지 시리즈',
    'placeholder.seriesDescription': '시리즈 개요', 'placeholder.enterCode': '코드 입력',
    'placeholder.eventName': '이벤트 이름', 'placeholder.memoOptional': '메모 (선택)',
    'placeholder.seriesExample2': '예: 이세계 모험 시리즈', 'placeholder.seriesOverview': '시리즈 개요 입력...',
    'placeholder.episodeExample': '예: 1화 모험의 시작',
  ...
  fr: {
    'app.title': '葉桜', 'app.tagline': 'Votre compagnon d\'écriture omniscient',
  ...
  de: {
    'app.title': '葉桜', 'app.tagline': 'Ihr allwissender Schreibbegleiter',
  ...
  pt: {
    'app.title': '葉桜', 'app.tagline': 'Seu companheiro de escrita onisciente',
  ...
  ru: {
    'app.title': '葉桜', 'app.tagline': 'Ваш всезнающий помощник в писательстве',
  ...
  ar: {
    'app.title': '葉桜', 'app.tagline': 'رفيقك الكتابي العليم',
  ...
  hi: {
    'app.title': '葉桜', 'app.tagline': 'आपका सर्वज्ञ लेखन साथी',
  ...
  th: {
    'app.title': '葉桜', 'app.tagline': 'ผู้ช่วยเขียนที่รอบรู้ของคุณ',
...
function hasStandardPlan() {
  ...
  const planType = state.user.plan_type || 'free';
  // 'standard' or 'premium' or 'lifetime' plans have full access
  return ['standard', 'premium', 'lifetime'].includes(planType);
}

// Check if a feature is available for current plan
function isFeatureAvailable(feature) {
  // Features that require standard plan
  const premiumFeatures = ['series', 'analysis_chat', 'research', 'x_trends'];
  
  if (premiumFeatures.includes(feature)) {
    return hasStandardPlan();
  }
  return true;
}

// Show upgrade prompt when premium feature is accessed
function showUpgradePrompt(featureName) {
  const isJa = (state.user?.settings?.language || 'ja') === 'ja';
  const featureNames = {
    series: isJa ? 'シリーズ構成' : 'Series Management',
    analysis_chat: isJa ? '分析・相談AI' : 'Analysis & Consultation AI',
    research: isJa ? 'リサーチ機能' : 'Research Feature',
    x_trends: isJa ? 'Xトレンド調査' : 'X Trends Research'
  };
  const name = featureNames[featureName] || featureName;
  const message = isJa 
    ? `「${name}」はスタンダードプラン以上でご利用いただけます。\\n\\nアップグレードしますか？`
    : `"${name}" is available for Standard plan and above.\\n\\nWould you like to upgrade?`;
  
  if (confirm(message)) {
    openModal('settings');
    // Switch to plan tab
    setTimeout(() => {
      const planTab = document.querySelector('[data-settings-tab="plan"]');
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md animate-fade-in">
        <div class="text-center mb-8">
          <div class="flex items-center justify-center mb-2">
            <img src="/static/favicon.png?v=2" alt="葉桜" class="h-40">
          </div>
      ...
      <div class="text-center max-w-md">
        ...
        <div class="mb-6">
          <div class="mx-auto flex items-center justify-center">
            <img src="/static/favicon.png?v=2" alt="葉桜" class="h-48">
          </div>
        </div>
    ...
    <div class="space-y-3">
      <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
        ...
        <textarea id="plot-ki" rows="3" 
          ...
          placeholder="${t('placeholder.storyBeginning')}"
      ...
      <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
        ...
        <textarea id="plot-sho" rows="3" 
          class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
          placeholder="${t('placeholder.storyDevelopment')}"
      ...
      <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
        ...
        <textarea id="plot-ten" rows="3" 
          class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
          placeholder="${t('placeholder.climax')}"
      ...
      <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
        ...
        <textarea id="plot-ketsu" rows="3" 
          class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
          placeholder="${t('placeholder.storyEnding')}"
    ...
    <div class="space-y-3">
      <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
        ...
        <textarea id="plot-act1" rows="4" 
          class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
          placeholder="${t('placeholder.settingIntro')}"
      ...
      <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
        ...
        <textarea id="plot-act2" rows="4" 
          class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
          placeholder="${t('placeholder.conflictStruggle')}"
      ...
      <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
        ...
        <textarea id="plot-act3" rows="4" 
          class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
          placeholder="${t('placeholder.climaxResolution')}"
          ...
          ${template === 'kishotenketsu' ? `
            <div class="space-y-3">
              <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                ...
                <textarea id="plot-ki" rows="3" 
                  class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
                  placeholder="${t('placeholder.kiDescription')}"
                  oninput="updatePlotStructure('ki', this.value)">${structure.ki || ''}</textarea>
              </div>
              <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                <label class="block text-sm font-semibold text-orange-600 dark:text-orange-400 mb-1">
                ...
                <textarea id="plot-sho" rows="3" 
                  class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
                  placeholder="${t('placeholder.shoDescription')}"
                  oninput="updatePlotStructure('sho', this.value)">${structure.sho || ''}</textarea>
              </div>
              <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                <label class="block text-sm font-semibold text-orange-600 dark:text-orange-400 mb-1">
                ...
                <textarea id="plot-ten" rows="3" 
                  class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
                  placeholder="${t('placeholder.tenDescription')}"
                  oninput="updatePlotStructure('ten', this.value)">${structure.ten || ''}</textarea>
              </div>
              <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                <label class="block text-sm font-semibold text-orange-600 dark:text-orange-400 mb-1">
                ...
                <textarea id="plot-ketsu" rows="3" 
                  class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
                  placeholder="${t('placeholder.ketsuDescription')}"
                  oninput="updatePlotStructure('ketsu', this.value)">${structure.ketsu || ''}</textarea>
              </div>
            </div>
          ` : `
            <div class="space-y-3">
              <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                ...
                <textarea id="plot-act1" rows="4" 
                  class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
                  placeholder="${t('placeholder.act1Description')}"
                  oninput="updatePlotStructure('act1', this.value)">${structure.act1 || ''}</textarea>
              </div>
              <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                <label class="block text-sm font-semibold text-orange-600 dark:text-orange-400 mb-1">
                ...
                <textarea id="plot-act2" rows="4" 
                  class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
                  placeholder="${t('placeholder.act2Description')}"
                  oninput="updatePlotStructure('act2', this.value)">${structure.act2 || ''}</textarea>
              </div>
              <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                <label class="block text-sm font-semibold text-orange-600 dark:text-orange-400 mb-1">
                ...
                <textarea id="plot-act3" rows="4" 
                  class="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none"
                  placeholder="${t('placeholder.act3Description')}"
                  oninput="updatePlotStructure('act3', this.value)">${structure.act3 || ''}</textarea>
              </div>
            </div>
          `}
            ...
            ${state.showQuickIdeas ? `
              <div class="p-4">
                <div class="flex gap-2 mb-3">
                  <input type="text" id="quick-idea-keywords" placeholder="${t('placeholder.keywords')}"
                    class="flex-1 px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 text-sm">
        ...
        <div class="p-3 border-t dark:border-gray-700">
          <div class="flex gap-2">
            <input type="text" id="ideas-chat-input" 
              placeholder="${t('placeholder.askAboutIdeas')}"
              class="flex-1 px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 text-sm"
          ...
          <div class="space-y-3">
            <div>
              ...
              <textarea id="illustration-prompt" rows="4" 
                placeholder="${t('placeholder.illustrationPrompt')}"
    ...
    <div class="h-full flex flex-col mobile-writing-container">
      ...
      <div class="flex-1 bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden relative">
        <textarea id="editor" 
          ...
          placeholder="${t('placeholder.writeStory')}"
          ...
          <div class="p-4 flex-1 overflow-y-auto">
            ...
            <div class="flex gap-2">
              <input type="text" id="mobile-ai-custom-prompt" 
                placeholder="${t('placeholder.aiInstruction')}"
...
function renderAnalysisChatTab() {
  // Check if user has standard plan for analysis/consultation feature
  if (!isFeatureAvailable('analysis_chat')) {
    const isJa = (state.user?.settings?.language || 'ja') === 'ja';
    return `
      <div class="h-full flex items-center justify-center">
        <div class="text-center p-8 max-w-md">
          <div class="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-full flex items-center justify-center">
            <i class="fas fa-lock text-white text-3xl"></i>
          </div>
          <h3 class="text-xl font-bold mb-2">${isJa ? '分析・相談AIはスタンダードプラン限定' : 'Analysis & Consultation AI is Standard Plan Only'}</h3>
          <p class="text-gray-600 dark:text-gray-400 mb-6">
            ${isJa ? '作品の分析、批評、AIとの相談機能をご利用いただくには、スタンダードプランへのアップグレードが必要です。' : 'To use work analysis, critique, and AI consultation features, please upgrade to Standard plan.'}
          </p>
          <button onclick="showUpgradePrompt('analysis_chat')" 
            class="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-medium hover:shadow-lg transition">
            <i class="fas fa-crown mr-2"></i>${isJa ? 'プランをアップグレード' : 'Upgrade Plan'}
          </button>
        </div>
      </div>
    `;
          ...
          <div class="p-2 border-t border-gray-200 dark:border-gray-700">
            <form id="analysis-chat-form" class="flex gap-2">
              <input type="text" id="analysis-chat-input" 
                placeholder="${t('placeholder.askQuestion')}"
                class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm dark:bg-gray-700">
              <button type="submit" 
      ...
      <div class="flex-1 flex gap-4 min-h-0">
        ...
        <div class="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-sm flex flex-col overflow-hidden">
          ...
          <div class="p-3 border-t border-gray-200 dark:border-gray-700">
            <form id="analysis-chat-form" class="flex gap-2">
              <input type="text" id="analysis-chat-input" 
                placeholder="${t('placeholder.askAboutWork')}"
      ...
      <div class="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-sm flex flex-col overflow-hidden">
        ...
        <div class="p-4 border-t border-gray-200 dark:border-gray-700">
          <form id="chat-form" class="flex gap-2">
            <input type="text" id="chat-input" placeholder="${t('placeholder.consultAI')}"
...
function checkAndUpdateBadgeHistory() {
  ...
  if (shouldFinalize && currentTier && (isNewMonth || isHigherTier)) {
    ...
    const tierNames = { platinum: t('achievement.platinum'), gold: t('achievement.gold'), silver: t('achievement.silver'), bronze: t('achievement.bronze'), encouragement: t('achievement.encouragement') };
    ...
    <div id="modal-legal" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50 modal-backdrop" onclick="handleModalBackdropClick(event, 'legal')">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 w-full max-w-2xl m-4 animate-fade-in relative max-h-[90vh] overflow-y-auto" onclick="event.stopPropagation()">
        ...
        <div id="legal-content-terms" class="prose dark:prose-invert max-w-none text-sm">
          ...
          <p>本規約は、合同会社RATIO Lab.（以下「当社」）が提供するAI統合ライティングエディター「葉桜」（以下「本サービス」）の利用に関する条件を定めるものです。</p>
    ...
    <div id="modal-calendarEvent" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-[60] modal-backdrop" onclick="handleModalBackdropClick(event, 'calendarEvent')">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 w-full max-w-md m-4 animate-fade-in relative" onclick="event.stopPropagation()">
        ...
        <div id="calendar-event-form" class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium mb-1">タイトル</label>
            <input type="text" id="event-title" class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600" placeholder="${t('placeholder.eventName')}">
          </div>
          <div>
            <label class="block text-sm font-medium mb-1">説明</label>
            <textarea id="event-description" rows="3" class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 resize-none" placeholder="${t('placeholder.memoOptional')}"></textarea>
          </div>
          <div class="flex items-center gap-2">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 w-full max-w-lg m-4 animate-fade-in relative" onclick="event.stopPropagation()">
        ...
        <form id="new-library-form" class="space-y-4">
          <div>
            ...
            <input type="text" id="new-library-title" required placeholder="${t('placeholder.seriesExample2')}"
              class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600">
          </div>
          <div>
            <label class="block text-sm font-medium mb-1">${t('ui.seriesDescOptional')}</label>
            <textarea id="new-library-description" rows="2" placeholder="${t('placeholder.seriesOverview')}"
...
window.createLibrary = async (title, description = '', genre = '') => {
  ...
  if (!isFeatureAvailable('series')) {
    showUpgradePrompt('series');
    return;
  }
  try {
  ...
  const content = `
    ...
    <div class="mb-6">
      ...
      <form id="create-child-project-form" class="space-y-3">
        ...
        <div>
          <label class="block text-sm font-medium mb-1">タイトル</label>
          <input type="text" id="child-project-title" required placeholder="${t('placeholder.episodeExample')}"
            class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600">
        </div>
        <div class="flex items-center gap-2">
    ...
    <form id="library-settings-form" class="space-y-4">
      ...
      <div>
        ...
        <textarea id="library-description" rows="2" 
          ...
          placeholder="${t('placeholder.seriesOverview')}">${settings.description || ''}</textarea>
      </div>
      ...
      <div>
        ...
        <textarea id="library-shared-characters" rows="6" 
          class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600"
          placeholder="${t('placeholder.sharedCharacters')}">${settings.shared_characters || ''}</textarea>
      </div>
      ...
      <div>
        ...
        <textarea id="library-shared-world" rows="6" 
          class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600"
          placeholder="${t('placeholder.sharedWorld')}">${settings.shared_world_setting || ''}</textarea>
      </div>
      ...
      <div>
        ...
        <textarea id="library-shared-terminology" rows="4" 
          class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600"
          placeholder="${t('placeholder.sharedTerminology')}">${settings.shared_terminology || ''}</textarea>
      </div>
...
window.toggleSettingsAIMode = () => {
  // Check if switching to research mode requires standard plan
  if (state.settingsAIMode !== 'research' && !isFeatureAvailable('research')) {
    showUpgradePrompt('research');
    return;
  }
