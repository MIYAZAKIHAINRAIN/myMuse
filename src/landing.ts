...
<head>
  ...
  <title>Hazakura</title>
  <meta name="description" content="葉桜は小説家・作家のためのAI創作支援アプリ。執筆補助、プロット構成、キャラクター開発をAIがサポート。あなたの物語を、もっと遠くへ。">
  ...
  <link rel="icon" type="image/png" sizes="256x256" href="/static/favicon-256x256.png?v=3">
  <link rel="icon" type="image/png" sizes="192x192" href="/static/favicon-192x192.png?v=3">
  <link rel="icon" type="image/png" sizes="128x128" href="/static/favicon-128x128.png?v=3">
  <link rel="icon" type="image/png" sizes="96x96" href="/static/favicon-96x96.png?v=3">
  <link rel="icon" type="image/png" sizes="64x64" href="/static/favicon-64x64.png?v=3">
  <link rel="icon" type="image/png" sizes="48x48" href="/static/favicon-48x48.png?v=3">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center">
          <img src="/static/favicon.png?v=2" alt="葉桜" class="h-24">
        </div>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="text-center lg:text-left">
          ...
          <p class="text-lg sm:text-xl text-indigo-200 mb-8 leading-relaxed">
            葉桜は、小説家・作家のためのAI創作パートナー。<br class="hidden sm:block">
          ...
          <div class="relative z-10 animate-float">
            <div class="bg-gray-900 rounded-2xl shadow-2xl overflow-hidden border border-gray-700">
              ...
              <div class="bg-gray-800 px-4 py-3 flex items-center gap-2">
                ...
                <div class="flex-1 text-center text-gray-400 text-sm">葉桜</div>
              </div>
              <!-- App mockup content -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16 scroll-reveal">
        ...
        <p class="text-gray-600 text-lg max-w-2xl mx-auto">
          アイデア出しから執筆、分析まで。葉桜があなたの創作活動をトータルサポート。
        </p>
      </div>
      ...
      <div class="space-y-4">
        <div class="bg-gray-50 rounded-2xl overflow-hidden scroll-reveal">
          ...
          <div class="px-6 pb-5 hidden">
            <p class="text-gray-600">AIを補助ツールとして使用し、ユーザーが創作・編集した作品の著作権はユーザーに帰属します。葉桜はユーザーのコンテンツを一切使用・販売しません。</p>
          </div>
        </div>
        ...
        <div class="bg-gray-50 rounded-2xl overflow-hidden scroll-reveal">
          ...
          <div class="px-6 pb-5 hidden">
            <p class="text-gray-600">はい。葉桜はレスポンシブデザインに対応しており、スマートフォンやタブレットでも快適にご利用いただけます。</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="bg-gray-900 text-gray-400 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <p class="text-sm">© 2026 葉桜 / RATIO Lab. All rights reserved.</p>
      </div>
    </div>
  </footer>
